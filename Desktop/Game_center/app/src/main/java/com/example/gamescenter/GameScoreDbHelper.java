...
public class GameScoreDbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 2) {
            // If we need to add new columns for version 2
            // Example: db.execSQL("ALTER TABLE " + TABLE_SCORES + " ADD COLUMN new_column TEXT");

            // Since we don't have actual migration needs, just log it
            Log.d(TAG, "No schema changes needed for upgrade to version 2");
        }
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    entry.date = cursor.getString(cursor.getColumnIndexOrThrow(KEY_SCORE_DATE));
    ...
    public void updateScoresList(Context context, ListView listView, String gameFilter, String playerFilter) {
        ...
        for (ScoreEntry entry : filteredScores) {
            String scoreText = entry.playerName + " - " + entry.gameName + " - " + entry.score;
    ...
    public static class ScoreEntry {
        ...
        public String toString() {
            return playerName + " - " + gameName + " - " + score;
        }
    }
    ...
    public void insertScore(String playerName, String gameName, int score) {
        ...
        values.put(KEY_SCORE_DATE, System.currentTimeMillis()); // Timestamp
